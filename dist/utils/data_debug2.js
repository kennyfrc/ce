...
export var setValue = function (cell, value, force) {
    ...
    export var getData = function (highlighted, processed, delimiter, asJson) {
        ...
        var x = obj.options.data ? Math.max.apply(Math, obj.options.data.map(function (row) {
            return row.length;
        })) : 0;
        var y = obj.options.data ? obj.options.data.length : 0;
...
//# sourceMappingURL=data_debug2.js.map