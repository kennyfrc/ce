 ...
 */
export var getHeader = function (column) {
    var obj = this;
 ...
 * @return mixed
 */
export var getHeaders = function (asArray) {
    var obj = this;
    var title = [];
 ...
 * @param title - new column title
 */
export var setHeader = function (column, newValue) {
    var obj = this;
    if (obj.headers[column]) {
        var oldValue = obj.headers[column].textContent;
        var onchangeheaderOldValue = (obj.options.columns && obj.options.columns[column] && obj.options.columns[column].title) || '';
        if (!newValue) {
