 ...
 * Update order arrow
 */
export var updateOrderArrow = function (column, order) {
    var obj = this;
    // Remove order
 ...
 */
export var updateOrder = function (rows) {
    var obj = this;
    // History
    var data = [];
 ...
 */
export var orderBy = function (column, order) {
    var obj = this;
    if (column >= 0) {
        // Merged cells
        ...
        // On sort event
        dispatch.call(obj, 'onsort', obj, column, order, newValue.map(function (row) { return row; }));
        return true;
    }
};
