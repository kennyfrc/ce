    ...
    if (libraryBase.jspreadsheet.current) {
        ...
        if (libraryBase.jspreadsheet.current.resizing) {
            ...
            if (libraryBase.jspreadsheet.current.resizing.column) {
                // New width
                var newWidth = parseInt(libraryBase.jspreadsheet.current.cols[libraryBase.jspreadsheet.current.resizing.column].colElement.getAttribute('width'));
                // Columns
                var columns = libraryBase.jspreadsheet.current.getSelectedColumns();
                if (columns.length > 1) {
                    var currentWidth = [];
                    ...
                    // Previous width
                    var index = columns.indexOf(parseInt(libraryBase.jspreadsheet.current.resizing.column));
                ...
                for (var j = 0; j < libraryBase.jspreadsheet.current.records.length; j++) {
                ...
                var newHeight = libraryBase.jspreadsheet.current.rows[libraryBase.jspreadsheet.current.resizing.row].element.getAttribute('height');
            ...
            if (libraryBase.jspreadsheet.current.dragging) {
                if (libraryBase.jspreadsheet.current.dragging.column) {
                    ...
                    for (var j = 0; j < libraryBase.jspreadsheet.current.rows.length; j++) {
                    ...
                    for (var i = 0; i < libraryBase.jspreadsheet.current.headers.length; i++) {
...
var mouseDownControls = function (e) {
    ...
    // Get elements
    var jssTable = getElement(e.target);
    if (jssTable[0]) {
    ...
    if (libraryBase.jspreadsheet.current && mouseButton == 1) {
        if (e.target.classList.contains('jss_selectall')) {
            ...
            // Header found
            if (jssTable[1] == 1) {
                var columnId_1 = e.target.getAttribute('data-x');
                if (columnId_1) {
                    // Update cursor
                    ...
                    if (libraryBase.jspreadsheet.current.options.columnResize != false && info.width - e.offsetX < 6) {
                        ...
                        // Border indication
                        libraryBase.jspreadsheet.current.headers[columnId_1].classList.add('resizing');
                        for (var j = 0; j < libraryBase.jspreadsheet.current.records.length; j++) {
                            if (libraryBase.jspreadsheet.current.records[j][columnId_1]) {
                                libraryBase.jspreadsheet.current.records[j][columnId_1].element.classList.add('resizing');
                            }
                        }
                    }
                    else if (libraryBase.jspreadsheet.current.options.columnDrag != false && info.height - e.offsetY < 6) {
                        if (isColMerged.call(libraryBase.jspreadsheet.current, columnId_1).length) {
                            ...
                            libraryBase.jspreadsheet.current.dragging = {
                                element: e.target,
                                column: columnId_1,
                                destination: columnId_1,
                            };
                            // Border indication
                            libraryBase.jspreadsheet.current.headers[columnId_1].classList.add('dragging');
                            for (var j = 0; j < libraryBase.jspreadsheet.current.records.length; j++) {
                                if (libraryBase.jspreadsheet.current.records[j][columnId_1]) {
                                    libraryBase.jspreadsheet.current.records[j][columnId_1].element.classList.add('dragging');
                                }
                            }
                        }
                    }
                        ...
                        if (libraryBase.jspreadsheet.current.selectedHeader && (e.shiftKey || e.ctrlKey)) {
                            ...
                            // Press to rename
                            if (libraryBase.jspreadsheet.current.selectedHeader == columnId_1 && libraryBase.jspreadsheet.current.options.allowRenameColumn != false) {
                                libraryBase.jspreadsheet.timeControl = setTimeout(function () {
                                    libraryBase.jspreadsheet.current.setHeader(columnId_1);
                                }, 800);
                            }
                            // Keep track of which header was selected first
                            libraryBase.jspreadsheet.current.selectedHeader = columnId_1;
            ...
            // Body found
            if (jssTable[1] == 2) {
                var rowId = parseInt(e.target.getAttribute('data-y'));
                if (e.target.classList.contains('jss_row')) {
                    ...
                    if (e.target.classList.contains('jclose') && e.target.clientWidth - e.offsetX < 50 && e.offsetY < 50) {
                        ...
                        var getCellCoords_1 = function (element) {
                            ...
                            if (x && y) {
                                ...
                                if (element.parentNode) {
                                    return getCellCoords_1(element.parentNode);
                                }
                            }
                        };
                        var position = getCellCoords_1(e.target);
                        if (position) {
                            var columnId = position[0];
                            var rowId_1 = position[1];
                            // Close edition
                            if (libraryBase.jspreadsheet.current.edition) {
                                if (libraryBase.jspreadsheet.current.edition[2] != columnId || libraryBase.jspreadsheet.current.edition[3] != rowId_1) {
                                    closeEditor.call(libraryBase.jspreadsheet.current, libraryBase.jspreadsheet.current.edition[0], true);
                                }
                            }
                            if (!libraryBase.jspreadsheet.current.edition) {
                                ...
                                if (e.shiftKey) {
                                    updateSelectionFromCoords.call(libraryBase.jspreadsheet.current, libraryBase.jspreadsheet.current.selectedCell[0], libraryBase.jspreadsheet.current.selectedCell[1], columnId, rowId_1, e);
                                }
                                else {
                                    updateSelectionFromCoords.call(libraryBase.jspreadsheet.current, columnId, rowId_1, undefined, undefined, e);
                                }
                            }
...
var mouseMoveControls = function (e) {
    ...
    if (libraryBase.jspreadsheet.current) {
        if (libraryBase.jspreadsheet.isMouseAction == true) {
            ...
            if (libraryBase.jspreadsheet.current.resizing) {
                if (libraryBase.jspreadsheet.current.resizing.column) {
                    var width = e.pageX - libraryBase.jspreadsheet.current.resizing.mousePosition;
                    if (libraryBase.jspreadsheet.current.resizing.width + width > 0) {
                        var tempWidth = libraryBase.jspreadsheet.current.resizing.width + width;
                    ...
                    var height = e.pageY - libraryBase.jspreadsheet.current.resizing.mousePosition;
                    if (libraryBase.jspreadsheet.current.resizing.height + height > 0) {
                        var tempHeight = libraryBase.jspreadsheet.current.resizing.height + height;
 ...
 * @return void
 */
var updateCopySelection = function (x3, y3) {
    var obj = this;
    // Remove selection
...
var mouseOverControls = function (e) {
    e = e || window.event;
    var mouseButton;
    if (e.buttons) {
        mouseButton = e.buttons;
            ...
            if (libraryBase.jspreadsheet.current.resizing || libraryBase.jspreadsheet.current.dragging) {
                ...
                if (jssTable[1] == 1) {
                    if (libraryBase.jspreadsheet.current.selectedHeader) {
                        ...
                        var o = libraryBase.jspreadsheet.current.selectedHeader;
                        var d = columnId;
                        // Update selection
                        updateSelectionFromCoords.call(libraryBase.jspreadsheet.current, o, 0, d, libraryBase.jspreadsheet.current.options.data.length - 1, e);
                    }
                ...
                if (jssTable[1] == 2) {
                    if (e.target.classList.contains('jss_row')) {
                        if (libraryBase.jspreadsheet.current.selectedRow != null) {
                            var o = libraryBase.jspreadsheet.current.selectedRow;
                            var d = rowId;
                            // Update selection
...
var doubleClickControls = function (e) {
    // Jss is selected
    if (libraryBase.jspreadsheet.current) {
        // Corner action
        if (e.target.classList.contains('jss_corner')) {
            ...
            if (libraryBase.jspreadsheet.current.highlighted.length > 0) {
                // Copy from this
                var x1 = libraryBase.jspreadsheet.current.highlighted[0].element.getAttribute('data-x');
                var y1 = parseInt(libraryBase.jspreadsheet.current.highlighted[libraryBase.jspreadsheet.current.highlighted.length - 1].element.getAttribute('data-y')) + 1;
                // Until this
                var x2 = libraryBase.jspreadsheet.current.highlighted[libraryBase.jspreadsheet.current.highlighted.length - 1].element.getAttribute('data-x');
                var y2 = libraryBase.jspreadsheet.current.records.length - 1;
                // Execute copy
            ...
            if (jssTable[1] == 2 && libraryBase.jspreadsheet.current.options.editable != false) {
                if (!libraryBase.jspreadsheet.current.edition) {
                    var getCellCoords_2 = function (element) {
                        if (element.parentNode) {
                            var x = element.getAttribute('data-x');
                            var y = element.getAttribute('data-y');
                            if (x && y) {
                                ...
                                return getCellCoords_2(element.parentNode);
                            }
                        }
                    };
                    var cell = getCellCoords_2(e.target);
...
var defaultContextMenu = function (worksheet, x, y, role) {
    var items = [];
    if (role === 'header') {
        // Insert a new column
        ...
        if (worksheet.options.allowRenameColumn != false) {
            items.push({
                ...
                onclick: function () {
                    var oldValue = worksheet.getHeader(x);
                    var newValue = prompt(jSuites.translate('Column name'), oldValue);
    ...
    if (role === 'cell') {
        if (worksheet.options.allowComments != false) {
            items.push({ type: 'line' });
            var title_1 = worksheet.records[y][x].element.getAttribute('title') || '';
            items.push({
                title: jSuites.translate(title_1 ? 'Edit comments' : 'Add comments'),
                onclick: function () {
                    var comment = prompt(jSuites.translate('Comments'), title_1);
                    if (comment) {
...
var getElementIndex = function (element) {
    var parentChildren = element.parentElement.children;
    for (var i = 0; i < parentChildren.length; i++) {
        var currentElement = parentChildren[i];
...
var contextMenuControls = function (e) {
    e = e || window.event;
    if ("buttons" in e) {
    ...
    if (libraryBase.jspreadsheet.current) {
        var spreadsheet = libraryBase.jspreadsheet.current.parent;
        if (libraryBase.jspreadsheet.current.edition) {
            e.preventDefault();
        }
        else {
            ...
            if (libraryBase.jspreadsheet.current) {
                var role_1 = getRole(e.target);
                var x_1 = null, y_1 = null;
                if (role_1 === 'cell') {
                    var cellElement = e.target;
                    while (cellElement.tagName !== 'TD') {
                        cellElement = cellElement.parentNode;
                    }
                    y_1 = cellElement.getAttribute('data-y');
                    x_1 = cellElement.getAttribute('data-x');
                    if (!libraryBase.jspreadsheet.current.selectedCell ||
                        (x_1 < parseInt(libraryBase.jspreadsheet.current.selectedCell[0])) || (x_1 > parseInt(libraryBase.jspreadsheet.current.selectedCell[2])) ||
                        (y_1 < parseInt(libraryBase.jspreadsheet.current.selectedCell[1])) || (y_1 > parseInt(libraryBase.jspreadsheet.current.selectedCell[3]))) {
                        updateSelectionFromCoords.call(libraryBase.jspreadsheet.current, x_1, y_1, x_1, y_1, e);
                    }
                }
                else if (role_1 === 'row' || role_1 === 'header') {
                    if (role_1 === 'row') {
                        y_1 = e.target.getAttribute('data-y');
                    }
                    else {
                        x_1 = e.target.getAttribute('data-x');
                    }
                    if (!libraryBase.jspreadsheet.current.selectedCell ||
                        (x_1 < parseInt(libraryBase.jspreadsheet.current.selectedCell[0])) || (x_1 > parseInt(libraryBase.jspreadsheet.current.selectedCell[2])) ||
                        (y_1 < parseInt(libraryBase.jspreadsheet.current.selectedCell[1])) || (y_1 > parseInt(libraryBase.jspreadsheet.current.selectedCell[3]))) {
                ...
                else if (role_1 === 'nested') {
                    var columns = e.target.getAttribute('data-column').split(',');
                    x_1 = getElementIndex(e.target) - 1;
                    y_1 = getElementIndex(e.target.parentElement);
                    if (!libraryBase.jspreadsheet.current.selectedCell ||
                ...
                else if (role_1 === 'select-all') {
                    selectAll.call(libraryBase.jspreadsheet.current);
                }
                else if (role_1 === 'tabs') {
                    x_1 = getElementIndex(e.target);
                }
                else if (role_1 === 'footer') {
                    x_1 = getElementIndex(e.target) - 1;
                    y_1 = getElementIndex(e.target.parentElement);
                }
                // Table found
                var items_1 = defaultContextMenu(libraryBase.jspreadsheet.current, parseInt(x_1), parseInt(y_1), role_1);
                if (typeof spreadsheet.config.contextMenu === 'function') {
                    var result = spreadsheet.config.contextMenu(libraryBase.jspreadsheet.current, x_1, y_1, e, items_1, role_1, x_1, y_1);
                    if (result) {
                        items_1 = result;
                    }
                ...
                if (typeof spreadsheet.plugins === 'object') {
                    Object.entries(spreadsheet.plugins).forEach(function (_a) {
                        ...
                        if (typeof plugin.contextMenu === 'function') {
                            var result = plugin.contextMenu(libraryBase.jspreadsheet.current, x_1 !== null ? parseInt(x_1) : null, y_1 !== null ? parseInt(y_1) : null, e, items_1, role_1, x_1 !== null ? parseInt(x_1) : null, y_1 !== null ? parseInt(y_1) : null);
                            if (result) {
                                items_1 = result;
                            }
                        }
                ...
                spreadsheet.contextMenu.contextmenu.open(e, items_1);
                // Avoid the real one
                e.preventDefault();
            }
        }
...
var touchStartControls = function (e) {
    var jssTable = getElement(e.target);
    if (jssTable[0]) {
        if (libraryBase.jspreadsheet.current != jssTable[0].jssWorksheet) {
            if (libraryBase.jspreadsheet.current) {
    ...
    if (libraryBase.jspreadsheet.current) {
        if (!libraryBase.jspreadsheet.current.edition) {
            var columnId_2 = e.target.getAttribute('data-x');
            var rowId = e.target.getAttribute('data-y');
            if (columnId_2 && rowId) {
                updateSelectionFromCoords.call(libraryBase.jspreadsheet.current, columnId_2, rowId, undefined, undefined, e);
                libraryBase.jspreadsheet.timeControl = setTimeout(function () {
                    // Keep temporary reference to the element
                    if (libraryBase.jspreadsheet.current.options.columns[columnId_2].type == 'color') {
...
var touchEndControls = function (e) {
    // Clear any time control
    if (libraryBase.jspreadsheet.timeControl) {
        clearTimeout(libraryBase.jspreadsheet.timeControl);
        libraryBase.jspreadsheet.timeControl = null;
...
export var cutControls = function (e) {
    if (libraryBase.jspreadsheet.current) {
        if (!libraryBase.jspreadsheet.current.edition) {
            copy.call(libraryBase.jspreadsheet.current, true, undefined, undefined, undefined, undefined, true);
            if (libraryBase.jspreadsheet.current.options.editable != false) {
                libraryBase.jspreadsheet.current.setValue(libraryBase.jspreadsheet.current.highlighted.map(function (record) {
    ...
    if (libraryBase.jspreadsheet.current) {
        if (libraryBase.jspreadsheet.current.edition) {
            if (e.which == 27) {
                ...
                if (libraryBase.jspreadsheet.current.options.columns && libraryBase.jspreadsheet.current.options.columns[libraryBase.jspreadsheet.current.edition[2]] && libraryBase.jspreadsheet.current.options.columns[libraryBase.jspreadsheet.current.edition[2]].type == 'calendar') {
                ...
                else if (libraryBase.jspreadsheet.current.options.columns &&
                    ...
                    if ((libraryBase.jspreadsheet.current.options.wordWrap == true ||
                        ...
                        var editorTextarea = libraryBase.jspreadsheet.current.edition[0].children[0];
                        var editorValue = libraryBase.jspreadsheet.current.edition[0].children[0].value;
                ...
                // Tab
                if (libraryBase.jspreadsheet.current.options.columns &&
                    libraryBase.jspreadsheet.current.options.columns[libraryBase.jspreadsheet.current.edition[2]] &&
        ...
        if (!libraryBase.jspreadsheet.current.edition && libraryBase.jspreadsheet.current.selectedCell) {
            ...
            if (e.which == 37) {
                ...
                if ((e.ctrlKey || e.metaKey) && !e.shiftKey) {
                    ...
                    if (libraryBase.jspreadsheet.current.selectedCell) {
                        if (libraryBase.jspreadsheet.current.options.editable != false) {
                            var rowId = libraryBase.jspreadsheet.current.selectedCell[1];
                            var columnId = libraryBase.jspreadsheet.current.selectedCell[0];
                            // Characters able to start a edition
                            if (e.keyCode == 32) {
                                // Space
                                e.preventDefault();
                                if (libraryBase.jspreadsheet.current.options.columns[columnId].type == 'checkbox' ||
...
export var wheelControls = function (e) {
    var obj = this;
...
var scrollLeft = 0;
var updateFreezePosition = function () {
    var obj = this;
        ...
        for (var i = 0; i < obj.options.freezeColumns; i++) {
            ...
            for (var j = 0; j < obj.rows.length; j++) {
                if (obj.rows[j] && obj.records[j][i]) {
                    var shifted = (scrollLeft + (i > 0 ? obj.records[j][i - 1].element.style.width : 0)) - 51 + 'px';
...
export var scrollControls = function (e) {
    var obj = this;
...
export var setEvents = function (root) {
    destroyEvents(root);
...
export var destroyEvents = function (root) {
