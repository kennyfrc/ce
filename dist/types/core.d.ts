...
export interface ColumnDefinition {
    type?: "text" | "numeric" | "calendar" | "dropdown" | "checkbox" | "color" | "hidden";
    title?: string;
    width?: string | number;
    align?: "left" | "center" | "right";
    mask?: string;
...
export interface WorksheetInstance {
    ...
    selectedCell: number[];
    updateSelectionFromCoords: (x1: number, y1: number, x2: number, y3: number) => void;
...
export interface JSpreadsheet {
    ...
    getWorksheetInstanceByName(worksheetName: string, namespace: string): WorksheetInstance | null;
