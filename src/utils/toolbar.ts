  ...
  items.push({
    ...
    onclick: function () {
      ...
      if (
        ...
        if (
          worksheet.records[selectedRange[1]][
            selectedRange[0]
      ...
      if (worksheet.selectedCell) {
        ...
        if (selectedRange) {
          ...
          const setBorder = function (
            ...
            if (
              ((type === "border_top" || type === "border_outer") &&
                j === py) ||
            ...
            if (
              ((type === "border_left" || type === "border_outer") &&
                i === px) ||
          ...
          for (let j = selectedRange[1]; j <= selectedRange[3]; j++) {
            ...
            for (let i = selectedRange[0]; i <= selectedRange[2]; i++) {
              ...
              if (worksheet.records[j][i].element.getAttribute("data-merged")) {
                setBorder(
                  getCellNameFromCoords(selectedRange[0], selectedRange[1]),
                  i,
                  j
                );
              }
