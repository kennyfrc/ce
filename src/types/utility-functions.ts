// Utility function signatures for jspreadsheet
...
export interface ColumnFunctions {
  ...
  setWidth: (
    this: SpreadsheetContext,
    column: number | HTMLElement | number[],
    width: number | number[],
...
// Merge all utility function interfaces
export type UtilityFunctions = NavigationFunctions &
  RowFunctions &
  ColumnFunctions &
  SelectionFunctions &
  DataFunctions &
