...
const getCellNameFromCoords = function (x, y) {
    return (0, exports.getColumnName)(parseInt(String(x))) + (parseInt(String(y)) + 1);
};
exports.getCellNameFromCoords = getCellNameFromCoords;
...
exports.getCoordsFromCellName = getCoordsFromCellName;
const getCoordsFromRange = function (range) {
    const [start, end] = range.split(":");
    const startCoords = (0, exports.getCoordsFromCellName)(start);
    const endCoords = (0, exports.getCoordsFromCellName)(end);
    return [
        ...startCoords.filter((coord) => coord !== null),
        ...endCoords.filter((coord) => coord !== null),
    ];
};
exports.getCoordsFromRange = getCoordsFromRange;
/**
        ...
        for (let j = 0; j < content.length; j++) {
            ...
            if (options.parseTableFirstRowAsHeader == true &&
                ...
                for (let i = 0; i < content[j].children.length; i++) {
                    ...
                    // Key
                    const cellName = (0, internalHelpers_1.getColumnNameFromId)([i, j]);
                    // Classes
...
exports.createFromTable = createFromTable;
